...
#define whio_ht_empty_m {                       \
    ...
    */
    ...
    /**
       ...
       initialized via this function, as doing so will lead to
       confusing results.

       Clients can use whio_ht_hash() to calculate ht's hashcode for a
       given key.
...
extern "C" {
    ...
    */
    ...
    /** Used by inode handle objects. We can do away with this, using
        the whio_iomodes enum instead. The problem with removing it is
        that we have one too many levels of abstraction here to easily
        slide that in (inodes vs opened inode handles).
     */
    ...
    /**
       ...
       flag.
    */
    WHIO_EPFS_FLAG_INODE_IS_INTERNAL = 0x04,/*WHIO_EPFS_FLAG_RW,*/
    ...
    */
    struct whio_epfs
    {
        ...
        struct whio_epfs_hints
        {
            ...
            */
            ...
            /**
               ...
               How does this differ from blockCount? It doesn't seem
               to differ except for the duration of a few internal
               lines of code. We might be able to get rid of it.
            */
            ...
            */
            ...
            /**
               ...
               This member exists as a malloc() reduction
               ...
               Obviously, if the system's timezone, time, or DST
               changes after fs initialization, the resulting
               timestamps will be off. But those corner cases are
               worth the reduction in malloc() calls this gives me
               :-D.
        ...
        */
        ...
        {
            /**
               We stash the most recently freed block list here and
               recycle it when the next opened inode needs it. This is
               a malloc()-reduction optimization and costs very little
               memory unless someone has an inode with a huge block
               list (it's possible).
            */
...
#define whio_epfs_empty_m {                      \
    ...
    */
    ...
    /**
       A type containing data for initializing certain options of a
       ...
       To populate new instances of this object, always copy either
...
#define whio_epfs_setup_opt_empty_m {\
    ...
    */
    ...
    /**
       ...
       takeStore is false then ownership of store is not changed,
       store must outlive fs, and it must not be manipulated in any
       way (not even a seek()) except via the fs object. Ownership of
       store is never transfered if this function fails.
    ...
    */
    ...
    /**
       ...
       The given time is assumed to be seconds since the start of the
       Unix Epoch.
    ...
    */
    ...
    /**
       ...
       function returns 0 in that case).
    ...
    */
    ...
    /**
       ...
       If whio_epfs_has_namer(fs) then the namer is asked to remove
       the name mapping. If it fails with anything other than a
       whio_rc.NotFoundError, unlinking is _not_ performed and that
